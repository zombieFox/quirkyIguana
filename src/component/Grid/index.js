...
export const Grid = function() {
  ...
  this.bind = () => {
    ...
    window.addEventListener('scroll', () => {
      ...
      let windowSize, scrollStart, scrollSize;
      ...
      switch (config.grid.direction) {
        ...
        case 'horizontal':
          ...
          scrollStart = document.documentElement.scrollLeft;
      ...
      switch (this.view.getActive().id) {
        ...
        case this.view.all.line.id:
          ...
          if (windowSize + scrollStart >= (scrollSize - (windowSize * 0.3))) {
    ...
    this.node.grid.addEventListener('scroll', () => {
      ...
      switch (config.grid.direction) {
        ...
        case 'vertical':
          ...
          scrollStart = this.node.grid.scrollTop;

          scrollSize = this.node.grid.scrollHeight;
        ...
        case 'horizontal':
          ...
          scrollStart = this.node.grid.scrollLeft;

          scrollSize = this.node.grid.scrollWidth;
