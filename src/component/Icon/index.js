...
export const Icon = function(name, className) {
  ...
  this.shape = {
    ...
    arrowUp: [
      { d: 'M3.984 12l8.016-8.016 8.016 8.016-1.453 1.406-5.578-5.578v12.188h-1.969v-12.188l-5.625 5.578z' }
    ],
    arrowRight: [
      { d: 'M12 3.984l8.016 8.016-8.016 8.016-1.406-1.406 5.578-5.625h-12.188v-1.969h12.188l-5.578-5.625z' }
    ],
    arrowDown: [
      { d: 'M20.016 12l-8.016 8.016-8.016-8.016 1.453-1.406 5.578 5.578v-12.188h1.969v12.188l5.625-5.578z' }
    ],
    arrowLeft: [
    ...
    refresh: [
      { d: 'M17.672 6.328l2.344-2.344v7.031h-7.031l3.234-3.234c-1.078-1.078-2.578-1.781-4.219-1.781-3.328 0-6 2.672-6 6s2.672 6 6 6c2.625 0 4.875-1.641 5.672-3.984h2.063c-0.891 3.469-3.984 6-7.734 6-4.406 0-7.969-3.609-7.969-8.016s3.563-8.016 7.969-8.016c2.203 0 4.219 0.891 5.672 2.344z' }
    ],
    remove: [
      { d: 'M18.984 12.984h-13.969v-1.969h13.969v1.969z' }
    ],
    replay: [
    ...
    undo: [
      { d: 'M12.516 8.016q3.422 0 6.141 2.016t3.797 5.203l-2.344 0.75q-0.797-2.438-2.883-3.961t-4.711-1.523q-2.906 0-5.156 1.875l3.656 3.609h-9v-9l3.563 3.609q2.953-2.578 6.938-2.578z' }
    ],
    unfoldLess: [
      { d: 'M16.594 5.391l-4.594 4.594-4.594-4.594 1.406-1.406 3.188 3.188 3.188-3.188zM7.406 18.609l4.594-4.594 4.594 4.594-1.406 1.406-3.188-3.188-3.188 3.188z' }
    ],
    unfoldMore: [
    ...
    backwardSlash: [
      { d: 'M7.63379 6.43781L9.36584 5.43781L16.3658 17.5622L14.6338 18.5622L7.63379 6.43781Z' }
    ],
    forwardSlash: [
      { d: 'M14.6338 5.43781L16.3658 6.43781L9.36584 18.5622L7.63379 17.5622L14.6338 5.43781Z' }
    ],
    bar: [
      { d: 'M11 5H13V19H11V5Z' }
    ],
    ...
    upvote: [
      { d: 'M9 19H15V12H19L12 5L5 12H9V19Z' }
    ],
    comment: [
  ...
  this.render = () => {
    ...
    this.node.svg.setAttribute('version', '1.1');

    this.node.svg.setAttribute('viewBox', '0 0 24 24');

    this.node.svg.setAttribute('width', '24');

    this.node.svg.setAttribute('height', '24');

    this.shape[name].forEach(pathItem => {
