...
export const Guide = function() {
  ...
  this.content = [
    ...
    { key: ['L'], message: 'Load more media from Reddit.' },
  ...
  this.node = {
    ...
    description: node('p:Quirky Iguana has many features. These can be controlled with keybaord shortcuts.|class:Guide__description'),
